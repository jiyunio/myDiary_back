...
public class TestController {
    ...
    public String signup(Model model, @RequestParam("userName") String name, @RequestParam("userEmail") String email, @RequestParam("userId") String id, @RequestParam("userPw") String pw, @RequestParam("checkPw") String check) {
